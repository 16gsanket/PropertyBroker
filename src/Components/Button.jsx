...
function Button({ children, disabled, to, type, onClick }) {
  ...
  const base =
    'inline-block rounded-full bg-purple-500  font-semibold uppercase tracking-wide text-stone-200 transition-colors duration-300 hover:bg-purple-700 focus:bg-indigo-400 focus:outline-none focus:ring focus:ring-indigo-400 focus:ring-offset-2 disabled:cursor-not-allowed text-sm';
