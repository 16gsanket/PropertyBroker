...
function Maps({ data , filteredFlats }) {
  ...
  const filteredFlatsIdArray = filteredFlats?.map(filteredFlat=>filteredFlat.id)
      ...
      >
        ...
        */}
        ...
        {data?.map((data) => {
          ...
          return (
            <Marker position={data.geocode} icon={ filteredFlatsIdArray?.includes(data.id) ?customIcon :  CurrentCustomIcon  }>
